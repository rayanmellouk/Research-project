...
class PolicyNet(nn.Module) : 
    def __init__(self, num_alphas, num_assets, hidden_dim =300):
        super().__init__()
...
class DDRLAgent :
    ...
    def __init__(
        ...
        self.policy = PolicyNet(num_alphas=env.num_alphas, num_assets=env.num_assets, hidden_dim=hidden_dim).to(device)
